...
import cn.yq.springboot1.mapper.*;
...
//            if(parentComment.getCommentCount().equals(null)){
...
//            }
            ...
            //创建通知
            createNotify(comment, comment1.getCommentator(), commentator.getName(), question.getTitle(), NotificationTypeEnum.REPLY_COMMENT, question.getId());
        }else {
            //回复问题
    ...
    public List<CommentDTO> listByTargetId(Long id ,CommentTypeEnum type) {
        ...
        commentExample.setOrderByClause("gmt_create desc");//按照回复时间倒序排列
        ...
        userIds.addAll(commentators);//转换成userid
        //获取评论人并转换成map
